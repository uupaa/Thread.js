...
// --- implements ------------------------------------------
function ThreadPool_post(key,        // @arg UINT32 - keyword
                         value,      // @arg Any - value
                         postback,   // @arg Function = null - postback(key:UINT32, value:Any, postbackID:UINT32, event:Event):void function
...
//{@dev
    ...
    $valid($type(postback, "Function|omit"),                ThreadPool_post, "postback");
