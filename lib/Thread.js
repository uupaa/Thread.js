...
if (_runOnBrowser) {
    ...
    Thread["EXIT_CODE_OK"]      = EXIT_CODE_OK;
    Thread["EXIT_CODE_ERROR"]   = EXIT_CODE_ERROR;
    Thread["EXIT_CODE_FORCE"]   = EXIT_CODE_FORCE;
    Thread["EXIT_CODE_TIMEOUT"] = EXIT_CODE_TIMEOUT;
}
